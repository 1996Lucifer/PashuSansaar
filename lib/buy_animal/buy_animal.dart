                                                    ...
                                                    child: Row(children: [
                                                      ...
                                                      RaisedButton.icon(
                                                          ...
                                                          onPressed: () async {
                                                            ...
                                                            whatsappUrl =
                                                                "https://api.whatsapp.com/send/?phone=+91 ${_tempAnimalList[index].mobile}&text=$whatsappText";
                                                            await UrlLauncher
                                                                        .canLaunch(
                                                                            whatsappUrl) !=
                                                                    null
                                                                ...
                                                                : ScaffoldMessenger.of(
                                                                    ...
                                                                    .showSnackBar(
                                                                        SnackBar(
                                                                    content: Text(
                                                                        '${_tempAnimalList[index].mobile} is not present in Whatsapp'),
                                                                    duration: Duration(
                                                                        milliseconds:
                                                                            300),
                                                                    padding: EdgeInsets
              ...
              child: RaisedButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    final DynamicLinkParameters parameters =
                      ...
                      uriPrefix: uriPrefix,
                      link: Uri.parse(
                          'https://pashusansaar.com?data=${_list[index].sId}+${_list[index].userId}'),
